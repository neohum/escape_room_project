                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="post" action="{{ isset($task) ? route('tasks.update', $task->id) : route('tasks.store') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <x-text-input id="content" name="content" type="text" class="block w-full mt-1" :value="$task->content ?? old('content')" required autofocus /> Input field for task content
                        ...
                        <div>
                            ...
                            <label class="block mt-2">
                                ...
                                <input type="file" id="info_file" name="info_file" accept=".pdf,.docx,.doc,.xlsx,.xls" class="block w-full text-sm text-slate-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-violet-50 file:text-violet-700 hover:file:bg-violet-100 " /> {{-- File input field --}}
                            </label>
