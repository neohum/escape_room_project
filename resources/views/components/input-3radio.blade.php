...
<x-input-label for="title" :value="__('3지선다')" class="flex justify-items-center items-center" />
...
<p class="p-4 px-4 mt-4 text-sm font-semibold leading-tight text-white-800">
    ...
    <span class="ml-4">정답 :</span>
    <input type="radio" name="radio2" id="radio2" value="1" class="ml-5">
</p>
<p class="p-4 px-4 mt-4 text-sm font-semibold leading-tight text-white-800">
    ...
    <span class="ml-4">정답 :</span>
    <input type="radio" name="radio3" id="radio3" value="1" class="ml-5">
</p>
